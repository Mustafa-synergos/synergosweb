...
import type { WhoWeAreSectionData } from '@/types/home-sections';
...
export default function WhoWeAre({ data }: WhoWeAreProps) {
  ...
  const heading = data?.Heading ?? 'WE ARE\nSYNERGOS';
  const paragraphOne =
    data?.ParagraphOne ??
  ...
  return (
    <section className="relative min-h-[75vh] md:h-[65vh] overflow-hidden px-6 lg:px-8 md:pb-3" style={{ backgroundColor: '#171717' }}>
      ...
      items-center justify-center min-h-[70vh] py-12 md:py-10  lg:py-15">
