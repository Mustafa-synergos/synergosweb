...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: "Before anyone reads a word, they have already formed an opinion. We build the visual and verbal identity that shapes that opinion, giving your brand a mark, a voice, and a presence that holds across every touchpoint.",
